...
class Responsive extends StatelessWidget {
  ...
  static const widthMobile = 600;
  static const widthMiniTablet = 850;
  static const widthTablet = 1100;
  static const widthDesktop = 1250;
...
// This size work fine on my design, maybe you need some customization depends on your design
  ...
  static bool isTablet(BuildContext context) =>
      MediaQuery.of(context).size.width < 1250 && MediaQuery.of(context).size.width >= 1100;
