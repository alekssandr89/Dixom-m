...
/* Includes ------------------------------------------------------------------*/
#include "../../../Usb/COMPOSITE/App/usbd_desc.h"

#include "../../../Usb/COMPOSITE/Class/COMPOSITE/Inc/usbd_composite.h"
#include "../../../Usb/COMPOSITE/Core/Inc/usbd_core.h"
#include "../../../Usb/COMPOSITE/Target/usbd_conf.h"
...
#define USBD_MANUFACTURER_STRING      "DIXOM Electronics"
#if (USBD_USE_DFU == 1)
#define USBD_PID                      57105 // for DFU PID must be 57105, ST proprietary modification
#else
#define USBD_PID                      6
#endif
#define USBD_PRODUCT_STRING           "DIXOM AUDIO PLATFORM"
