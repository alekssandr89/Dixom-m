...
#include "../../../../../Usb/COMPOSITE/Core/Inc/usbd_ctlreq.h"
...
__ALIGN_BEGIN static uint8_t HID_KEYBOARD_ReportDesc[HID_KEYBOARD_REPORT_DESC_SIZE] __ALIGN_END =
    {
    	    ...
    	    0x81, 0x02,            //   Input (Data,Var,Abs,No Wrp,Linear,Preferred State,No Null Position, Bit)
    		...
    		0x81,   0x01,	       //      Input (Chst,Ary,Abs)
    		0x05,   0x01,          //      Usage (Generic Desktop Ctrls)
    		0x09,   0x30,          //      Usage (X)
    		0x09,   0x31,          //      Usage (Y)
    		...
    		0x75,   0x08,		   //      Report Size (8)
    		0x95,   0x03,		   //      Report Count (3)
    		0x81,   0x06,		   //      Input (Data,Var,Rel,No Wrp,Linear,Preferred State,No Null Position, Bit)
    		0xC0,                  //   End Collection
    		...
    		0xb1,	0x22,		   //   Feature (Data,Var,Abs,No Wrp,Linear,Preferred State,No Null Position, Bit)
    		0x75,   0x06, 	       //   Report Size (6)
    		0x95,   0x01,  	       //   Report Count (1)
    		0xb1,   0x01,		   //   Feature (Data,Var,Abs,No Wrp,Linear,Preferred State,No Null Position, Bit)
    		0xc0,                  // End Collection
    	    //SIZE SYSTEM CONTROL 27
    	    0x05, 0x01,            // Usage Page (Generic Desktop)
    	  	0x09, 0x80,            // Usage (System Control)
    	    0xA1, 0x01,            // Collection (Application)
    		0x85, 0x03,            //   Report ID (4)
    	  	0x19, 0x81,            //   Usage (System Power Down)
    	  	0x29, 0x83,            //   Usage (System Wake Up)
    	    0x15, 0x00,            //   Logical Minimum (0)
    	  	0x25, 0x01,            //   Logical Maximum (1)
    	  	0x75, 0x01,            //   Report Size (1)
    	  	0x95, 0x03,            //   Report Count (3)
    	  	0x81, 0x02,            //   Input (Data,Array,Abs,No Wrap,Linear,Preferred State,No Null Position,Bit)
    	  	0x95, 0x05,            //   Report Count (5)
    	  	0x81, 0x01,            //   Input (Data,Array,Abs)
    	  	0xC0,                  // End Collection
    		//SIZE MEDIA KEY 25
    		0x05, 0x0C,            // Usage Page (Consumer)
    	    0x09, 0x01,            // Usage (Consumer Control)
    		0xA1, 0x01,            // Collection (Application)
    	    0x85, 0x04,            //   Report ID (6)
    		0x19, 0x00,            //   Usage Minimum (Undefinied)
    		0x2A, 0xA5, 0x02,      //   Usage Maximum
    		0x15, 0x00,            //   Logical Minimum (0)
    		0x26, 0xA5, 0x02,      //   Logical Maximum (677)
    		0x95, 0x01,            //   Report Count (1)
