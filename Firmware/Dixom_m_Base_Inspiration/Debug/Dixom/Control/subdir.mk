...
C_SRCS += \
../Dixom/Control/Control.c 

OBJS += \
./Dixom/Control/Control.o 

C_DEPS += \
./Dixom/Control/Control.d 


# Each subdirectory must supply rules for building sources it contributes
Dixom/Control/%.o Dixom/Control/%.su Dixom/Control/%.cyclo: ../Dixom/Control/%.c Dixom/Control/subdir.mk
...
clean: clean-Dixom-2f-Control

clean-Dixom-2f-Control:
	-$(RM) ./Dixom/Control/Control.cyclo ./Dixom/Control/Control.d ./Dixom/Control/Control.o ./Dixom/Control/Control.su

.PHONY: clean-Dixom-2f-Control
